...
import com.hh.kit.entity.FormFile;

/**
 * @ClassName: HttpUtils
 * @Description: 此类用来发送HTTP请求
 * @author: Mr.Gdp
 * @date: 2013年11月4日 下午2:26:55
 */
public class HttpRequestUtil {
	...
	// FormFile formFile = new FormFile(file.getName(), file, "document",
	// "text/plain");
	// boolean isSuccess = HttpRequestUtil.uploadFile(
	// "http://192.168.0.103:8080/Server/FileServlet", null, formFile);
	// }
}
